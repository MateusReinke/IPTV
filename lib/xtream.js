...
// Calls our own /api/xtream proxy from the browser. POST (not a query
// string) so the account's server/username/password never end up in a URL -
// see app/api/xtream/route.js.
...
// Raw upstream stream URL - contains the account's username/password in its
// path (that's the Xtream Codes URL format). Server-only: called from
// app/api/play/lease/route.js, which immediately encrypts the result before
// handing anything back to the browser. Never call this from client code.
